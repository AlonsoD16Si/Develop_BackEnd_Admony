...
Crear las siguientes tablas en tu base de datos SQL Server:
...
CREATE TABLE gastos (
    ...
    tipo VARCHAR(20) DEFAULT 'unico', -- 'unico' o 'recurrente'
...
CREATE TABLE presupuestos (
    ...
    periodo VARCHAR(20) DEFAULT 'mensual', -- 'mensual', 'semanal', 'anual'
    created_at DATETIME DEFAULT GETDATE(),
    updated_at DATETIME DEFAULT GETDATE(),
    FOREIGN KEY (usuario_id) REFERENCES usuarios(id) ON DELETE CASCADE
);
